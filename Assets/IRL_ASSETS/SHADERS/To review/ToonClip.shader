Shader "Custom/Toon/Clip"
{
    Properties
    {
		...
		_ClipBand ("Clip Band Size", float) = 0.1
		_StartClip ("Start Clip", Vector) = (0, 0, 0, 1)
		_EndClip ("End Clip", Vector) = (0, 0, 0, 1)
    }
    SubShader
    {
		Tags 
		...
		fixed _ClipAmount, _ClipBand;
		fixed4 _StartClip, _EndClip;
        ...
        void surf (Input IN, inout ToonSurfaceOutput o)
        {
			...
			fixed3 dir = normalize(_EndClip - _StartClip);

			fixed grad = lerp(0, 1, dir + _ClipAmount);
