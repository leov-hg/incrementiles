        ...
        public void DrawUsage()
        {
			...
			*/
            ...
            if (usage.m_NeedsPermission)
            {
                ...
                EditorGUILayout.HelpBox("Currently, your iOS and Android builds REQUIRE the access to the device and photo gallery. " +
                "If you only want to use the asset in editor or do not require to access to the device gallery, use the button below. ", MessageType.Info);
            ...
            {
                EditorGUILayout.HelpBox("Currently, your iOS and Android builds DO NOT REQUIRE the access to the device and photo gallery. " +
